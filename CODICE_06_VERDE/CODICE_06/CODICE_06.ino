    ...
    if (key >= '0' && key <= '9') {
      ...
      if (inputNumero.length() == 2) {
        ...
        if (numero1 == '1') {
          ...
          leds_DECINE[9] = CRGB::blue;
          leds_DECINE[10] = CRGB::blue;
          leds_DECINE[11] = CRGB::blue;
          leds_DECINE[12] = CRGB::blue;
          leds_DECINE[13] = CRGB::blue;
          leds_DECINE[14] = CRGB::blue;
        ...
        if (numero1 == '2') {
          leds_DECINE[0] = CRGB::blue;
          leds_DECINE[1] = CRGB::blue;
          leds_DECINE[2] = CRGB::blue;
          leds_DECINE[3] = CRGB::Black;
          leds_DECINE[4] = CRGB::Black;
          leds_DECINE[5] = CRGB::Black;
          leds_DECINE[6] = CRGB::blue;
          leds_DECINE[7] = CRGB::blue;
          leds_DECINE[8] = CRGB::blue;
          leds_DECINE[9] = CRGB::blue;
          leds_DECINE[10] = CRGB::blue;
          leds_DECINE[11] = CRGB::blue;
          ...
          leds_DECINE[15] = CRGB::blue;
          leds_DECINE[16] = CRGB::blue;
          leds_DECINE[17] = CRGB::blue;
          leds_DECINE[18] = CRGB::blue;
          leds_DECINE[19] = CRGB::blue;
          leds_DECINE[20] = CRGB::blue;
        ...
        if (numero1 == '4') {
          ...
          leds_DECINE[1] = CRGB::blue;
          leds_DECINE[2] = CRGB::blue;
          leds_DECINE[3] = CRGB::blue;
          leds_DECINE[4] = CRGB::blue;
          leds_DECINE[5] = CRGB::blue;
          leds_DECINE[6] = CRGB::Black;
          leds_DECINE[7] = CRGB::Black;
          leds_DECINE[8] = CRGB::Black;
          leds_DECINE[9] = CRGB::blue;
        ...
        if (numero2 == '1') {
          ...
          leds_UNITA[9] = CRGB::blue;
          leds_UNITA[10] = CRGB::blue;
          leds_UNITA[11] = CRGB::blue;
          leds_UNITA[12] = CRGB::blue;
          leds_UNITA[13] = CRGB::blue;
          leds_UNITA[14] = CRGB::blue;
        ...
        if (numero2 == '2') {
          leds_UNITA[0] = CRGB::blue;
          leds_UNITA[1] = CRGB::blue;
          leds_UNITA[2] = CRGB::blue;
          leds_UNITA[3] = CRGB::Black;
          leds_UNITA[4] = CRGB::Black;
          leds_UNITA[5] = CRGB::Black;
          leds_UNITA[6] = CRGB::blue;
          leds_UNITA[7] = CRGB::blue;
          leds_UNITA[8] = CRGB::blue;
          leds_UNITA[9] = CRGB::blue;
          leds_UNITA[10] = CRGB::blue;
          leds_UNITA[11] = CRGB::blue;
          ...
          leds_UNITA[15] = CRGB::blue;
          leds_UNITA[16] = CRGB::blue;
          leds_UNITA[17] = CRGB::blue;
          leds_UNITA[18] = CRGB::blue;
          leds_UNITA[19] = CRGB::blue;
          leds_UNITA[20] = CRGB::blue;
        ...
        if (numero2 == '4') {
          ...
          leds_UNITA[1] = CRGB::blue;
          leds_UNITA[2] = CRGB::blue;
          leds_UNITA[3] = CRGB::blue;
          leds_UNITA[4] = CRGB::blue;
          leds_UNITA[5] = CRGB::blue;
          leds_UNITA[6] = CRGB::Black;
          leds_UNITA[7] = CRGB::Black;
          leds_UNITA[8] = CRGB::Black;
          leds_UNITA[9] = CRGB::blue;
